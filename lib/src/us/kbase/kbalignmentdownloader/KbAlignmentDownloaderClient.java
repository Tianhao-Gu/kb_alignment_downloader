...
/**
 * <p>Original spec-file module name: kb_alignment_downloader</p>
 * <pre>
 * A KBase module: kb_alignment_downloader
 * </pre>
 */
public class KbAlignmentDownloaderClient {
     ...
     */
    public KbAlignmentDownloaderClient(URL url) {
     ...
     * validity.
     */
    public KbAlignmentDownloaderClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbAlignmentDownloaderClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KbAlignmentDownloaderClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("kb_alignment_downloader.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
