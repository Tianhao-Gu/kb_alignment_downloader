...
function kb_alignment_downloader(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.export_rna_seq_alignment_as_excel = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_alignment_downloader.export_rna_seq_alignment_as_excel",
            [params], 1, _callback, _errorCallback);
    };
 
     this.export_rna_seq_alignment_as_tsv = function (params, _callback, _errorCallback) {
        if (typeof params === 'function')
            throw 'Argument params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "kb_alignment_downloader.export_rna_seq_alignment_as_tsv",
            [params], 1, _callback, _errorCallback);
    };
