...
import os
from kb_alignment_downloader.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_alignment_downloader'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_alignment_downloader.kb_alignment_downloaderImpl import kb_alignment_downloader  # noqa @IgnorePep8
impl_kb_alignment_downloader = kb_alignment_downloader(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_alignment_downloader'
